				...
				<swiper-container
					...
					<swiper-slide>
						<div
							...
							<CategoryCircle
								:isActive="activeCircleLive == 'all-events-circle'
										? true
										: false"
								title="All events"
								activeColor="yellow">
...
<script setup>
	...
	import SportCategoryTableLiveMenu from "@/views/coupon/SportCategoryTableLiveMenu.vue";
