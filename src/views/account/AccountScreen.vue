						...
						<div class="card">
							...
							<div class="cashier-content">
								<div class="payment-amount">
									Specify the amount to be issued
								</div>
								<BetAmountInput
									text="Amount"
									currency="USDT"
									:modelValue="cashierAmount"
									@update:modelValue="
										cashierAmount = $event
									" />
								<div class="amount-range">
								...
								<div class="separator separator-payments"></div>
								<div class="selector__list">
									<label
										:class="[
											'radio-label',
											cashierLabel === item.id
												? 'radio-label-checked'
												: '',
										]"
										v-for="item in cashiersList"
										:key="item.id">
										<input
											type="radio"
											:value="item.id"
											v-model="cashierLabel" />
								...
								<div class="issue-btn">
									<ButtonMedium text="Issue">
										<svg
											...
											xmlns="http://www.w3.org/2000/svg">
											<g
												clip-path="url(#clip0_4966_21909)">
												<path
					...
					<div class="card-bg">
						<div class="card">
							...
							<div class="bank-content">
								...
								<input type="text" class="input card-input" />
								<div class="issue-btn">
									<ButtonMedium text="Issue">
										<svg
											width="20"
...
<style lang="scss" scoped>
	...
	.separator {
		...
		background: linear-gradient(
			90deg,
			rgba(21, 30, 37, 0.53) 0%,
			rgba(254, 180, 36, 1) 50%,
			rgba(33, 40, 46, 0.55) 100%
		);
	}
